...
async function getParser(type) {
    switch(type){
        case "docling":
            {
                const { DoclingParser } = await __turbopack_context__.A("[project]/src/lib/parsers/docling-parser.ts [app-route] (ecmascript, async loader)");
        ...
        case "basic":
        default:
            const { BasicParser } = await __turbopack_context__.A("[project]/src/lib/parsers/basic-parser.ts [app-route] (ecmascript, async loader)");
...
async function processDocument(file, filename, docName, parserType = "basic", existingDocId) {
...
function getClient() {
    if (!client) {
        client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$qdrant$2f$js$2d$client$2d$rest$2f$dist$2f$esm$2f$qdrant$2d$client$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QdrantClient"]({
            ...
            httpsAgent: QDRANT_INSECURE_TLS ? new __TURBOPACK__imported__module__$5b$externals$5d2f$https__$5b$external$5d$__$28$https$2c$__cjs$29$__["default"].Agent({
    ...
    try {
        ...
        do {
            ...
            for (const point of points){
                ...
                const parserUsed = payload.parser_used || "basic";
...
async function POST(req) {
    try {
        ...
        // Get parser type
        const parserType = formData.get("parserType") || "basic";
        if (![
            "basic",
            "gemini",
            "docling"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8621ef81._.js.map