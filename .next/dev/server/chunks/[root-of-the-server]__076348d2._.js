...
"[project]/src/lib/parsers/gemini-parser.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class GeminiParser {
    ...
    constructor(){
        ...
        this.genAI = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](apiKey);
    ...
    async parse(file, filename) {
        ...
        try {
            ...
            for await (const imageBuffer of document){
                ...
                const text = await this.extractTextFromImage(Buffer.from(imageBuffer), pageNumber);
                pages.push({
                    pageNumber,
                    text,
            ...
            throw new Error(`Failed to parse PDF with Gemini: ${error.message}`);
        }
    }
    /**
   * Extract text from a page image using Gemini Vision
   */ async extractTextFromImage(imageBuffer, pageNumber) {
        try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__076348d2._.js.map